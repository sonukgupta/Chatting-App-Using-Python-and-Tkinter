...
# Code for Establish Connection....................................................................
    def est_con(self):
        try:
            host = simpledialog.askstring("Host Address", "Enter the Host Name or Host Address?")
            port = 8080
            s.connect((host, port))
            print("Connected to client")
            self.status.config(text="Connected", bg='lightgreen')
            self.ip.config(text=host)
            self.client_info.config(text=(host,port))
...
# Code for Window frame....................................................................
    ...
    # FRAME 1
        ...
        self.ip=Label(self.frame, text='IP Address', relief='sunken', anchor='center', width=25)
        self.ip.grid(row=1, column=2,ipadx=10, ipady=5)
        Label(self.frame, text='Using Port Number', relief="groove", anchor='center', width=25).grid(row=2, column=1,ipadx=10,ipady=5)
    ...
    # FRAME 2
        ...
        self.con_button = Button(self.frame2, text="Enter Host Name",command=self.est_con,bg='lightsalmon',width=15,font=('arial 10 bold '),activebackground='olivedrab')
